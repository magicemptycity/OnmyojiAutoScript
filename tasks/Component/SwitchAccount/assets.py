...
class SwitchAccountAssets: 
	...
	C_SA_LOGIN_FORM_CHARACTER_AREA = RuleClick(roi_front=(413,124,660,509), roi_back=(413,124,660,509), name="sa_login_form_character_area")
	# 登录界面-选择服务器-点击关闭选择服务器界面的空白区域 
	C_SA_LOGIN_FORM_CANCEL_SVR_SELECT = RuleClick(roi_front=(1063,90,45,45), roi_back=(1063,90,45,45), name="sa_login_form_cancel_svr_select")
	# 登录界面-用户中心-右上角关闭按钮 
	...
	# 登录界面-选择手机类型为苹果. 
	I_SA_LOGIN_FORM_APPLE = RuleImage(roi_front=(513,359,92,93), roi_back=(443,320,200,200), threshold=0.8, method="Template matching", file="./tasks/Component/SwitchAccount/res/sa_login_form_apple.png")
	# 登录界面-选择手机类型为android 
	I_SA_LOGIN_FORM_ANDROID = RuleImage(roi_front=(677,359,91,90), roi_back=(643,320,200,200), threshold=0.8, method="Template matching", file="./tasks/Component/SwitchAccount/res/sa_login_form_android.png")
	...
	# 判断是否 离开 选择服务器 出现则代表未离开 消失则代表离开了 
	...
	O_SA_SELECT_SVR_SVR_LIST = RuleOcr(roi=(422,131,654,495), area=(422,131,654,495), mode="FULL", method="Default", keyword="", name="sa_select_svr_svr_list")
	# 选择服务器界面 底部角色名 列表 
	O_SA_SELECT_SVR_CHARACTER_LIST = RuleOcr(roi=(422,131,654,495), area=(422,131,654,495), mode="FULL", method="Default", keyword="", name="sa_select_svr_character_list")
	# 选择账号界面 账号列表 
	...
	# Swipe Rule Assets
	# 登录界面 服务器列表的手指向上滑动 
	S_SA_SVR_SWIPE_LEFT = RuleSwipe(roi_front=(443,537,30,21), roi_back=(702,122,26,21), mode="default", name="sa_svr_swipe_left")
	# 登录界面 账号列表的手指向上滑动 
