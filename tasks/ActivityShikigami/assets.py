...
class ActivityShikigamiAssets: 
	...
	# 活动通用挑战图标 
	I_ACT_FIRE = RuleImage(roi_front=(1135,601,84,45), roi_back=(1080,530,192,190), threshold=0.8, method="Template matching", file="./tasks/ActivityShikigami/as/climb/as_act_fire.png")
	# boss挑战标志 
	...
	# 体力的数量检测 
	O_REMAIN_AP = RuleOcr(roi=(1142,14,95,34), area=(1142,14,95,34), mode="DigitCounter", method="Default", keyword="", name="remain_ap")
	# 活动体力的剩余检测 
