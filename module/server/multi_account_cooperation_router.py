...
multi_account_cooperation_app = APIRouter(route_class=ApiLoggingRoute)


def _section(script_name: str):
    section = getattr(mm.config_cache(script_name).model, "multi_account_cooperation", None)
    if section is None:
        raise HTTPException(status_code=404, detail="当前配置没有多账号协战")
    return section
...
@multi_account_cooperation_app.get('/{script_name}/multi_account_cooperation/accounts')
...
@multi_account_cooperation_app.post('/{script_name}/multi_account_cooperation/accounts')
...
@multi_account_cooperation_app.put('/{script_name}/multi_account_cooperation/accounts/{account_index}/enable')
...
@multi_account_cooperation_app.delete('/{script_name}/multi_account_cooperation/accounts/{account_index}')
...
@multi_account_cooperation_app.post('/{script_name}/multi_account_cooperation/accounts/{account_index}/tasks')
...
@multi_account_cooperation_app.put('/{script_name}/multi_account_cooperation/accounts/{account_index}/tasks/order')
...
@multi_account_cooperation_app.delete('/{script_name}/multi_account_cooperation/accounts/{account_index}/tasks/{task_name}')
...
@multi_account_cooperation_app.put('/{script_name}/multi_account_cooperation/accounts/{account_index}/tasks/{task_name}/status')
...
@multi_account_cooperation_app.put('/{script_name}/multi_account_cooperation/accounts/{account_index}/task-progress')
...
@multi_account_cooperation_app.put('/{script_name}/multi_account_cooperation/accounts/{account_index}/last-complete-time')
...
@multi_account_cooperation_app.post('/{script_name}/multi_account_cooperation/accounts/{account_index}/rerun')
...
@multi_account_cooperation_app.get('/{script_name}/multi_account_cooperation/public-args')
...
@multi_account_cooperation_app.put('/{script_name}/multi_account_cooperation/public-args/{group}/{argument}/value')
async def set_public_arg(script_name: str, group: str, argument: str, types: str, value):
    ...
    _save(script_name, multi_account_cooperation=candidate)
    await _broadcast_schedule(script_name)
    return True


@multi_account_cooperation_app.get('/{script_name}/multi_account_cooperation/accounts/{account_index}/tasks/{task_name}/args')
...
@multi_account_cooperation_app.put('/{script_name}/multi_account_cooperation/accounts/{account_index}/tasks/{task_name}/{group}/{argument}/value')
...
@multi_account_cooperation_app.post('/{script_name}/multi_account_cooperation/accounts/{account_index}/tasks/{task_name}/private/copy')
...
@multi_account_cooperation_app.put('/{script_name}/multi_account_cooperation/accounts/{account_index}/tasks/{task_name}/private/default')
