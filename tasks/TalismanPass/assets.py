...
class TalismanPassAssets:
	...
	# 成就入口
	I_ACCOMPLISHMENTS_1 = RuleImage(roi_front=(1081,638,55,56), roi_back=(1035,606,245,114), threshold=0.8, method="Template matching", file="./tasks/TalismanPass/tp/tp_accomplishments_1.png")
	# 成就页面标志
	I_ACCOMPLISHMENTS_2 = RuleImage(roi_front=(102,21,72,42), roi_back=(102,21,72,42), threshold=0.8, method="Template matching", file="./tasks/TalismanPass/tp/tp_accomplishments_2.png")
	# 没有可领取的成就奖励
	I_ACCOMPLISHMENTS_3 = RuleImage(roi_front=(1077,423,36,42), roi_back=(1077,423,36,42), threshold=0.8, method="Template matching", file="./tasks/TalismanPass/tp/tp_accomplishments_3.png")
